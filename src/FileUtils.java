...
public class FileUtils {
	...
	public static void test1() throws IOException, Exception, Throwable {
	 writeData( "Sheet1", 2, "RollNo", "001	");
		}


	public static void writeData( String sheetName, int rowNum, String cellNum, String value) throws IOException, EncryptedDocumentException, OpenXML4JException{
